                        ...
                        <tr data-entry-id="{{ $schoolClass->id }}">
                            ...
                            <td>
                                @can('school_class_show')
                                    <a class="btn btn-xs btn-success" href="{{ route('admin.school-classes.show', $schoolClass->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('school_class_edit')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.school-classes.edit', $schoolClass->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
